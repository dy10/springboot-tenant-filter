...
// duplicate of Document.java but doesnt implement MyBase, so hibernate filter doesnt apply to it

@Entity
public class NonFilterEntity {
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			NonFilterEntity other = (NonFilterEntity) obj;
		...
		public String toString() {
			return "NonFilterEntity [id=" + id + ", tenant=" + tenant + ", subTenant=" + subTenant + ", documentName="
